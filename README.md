...
For the most predictable builds, pin an exact version tag such as `@v1.4.6`. Use `@v1` only when you want to receive the latest compatible `v1.x.y` release automatically.
